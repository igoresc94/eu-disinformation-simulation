...
export const Menu = ({ categories, articles, menuVisible }) => {
    ...
    return html` <style>
        ...
        <nav id="menu" class="menu ${menuVisible ? 'menu-open' : ''}">
            <ul class="menu-list">
                <li class="item">
                          <p class="article-name">Understanding Disinformation Simulator</p>
                ...
                <li class="item">
                    ...
                    <a
                        ...
                        title="About EU parliament seats"
                        class="item-link"
                        onClick=${avoidReload}
                    >
                        About EU parliament seats
                    </a>
                </li>
                <li class="item">
                    ...
                    <a
                        ...
                        title="EU parliament seats by country"
                        class="item-link"
                        onClick=${avoidReload}
                    >
                        EU parliament seats by country
                    </a>
                </li>
            </ul>
            <hr class="separator" />
          <p class="article-name">Articles</p>
            <ul class="menu-list">
